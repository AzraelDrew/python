...
(
    ...
    .set_global_opts(title_opts=opts.TitleOpts(title='温度趋势'),
                     ...
                     # 'none': 什么都不触发
                     #  trigger: str="item",
                     tooltip_opts=opts.TooltipOpts(trigger='xaxis'),
...
#     Line()
#     .add_xaxis(x1)
#     .add_yaxis(series_name="2019年降水量", y_axis=y01, linestyle_opts=opts.LineStyleOpts(color='green'))
...
#                                               axislabel_opts=opts.LabelOpts(rotate=-30)),
#                      # 刻度线
#                      yaxis_opts=opts.AxisOpts(splitline_opts=opts.SplitLineOpts(True)))
#     .render('201120.html')
